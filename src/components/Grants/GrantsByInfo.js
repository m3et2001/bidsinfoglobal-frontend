...
export default function GrantsByInfo() {
    const [visible, setVisible] = useState(false);

    return (
        <div className='section-title sectionList ListPageSection'>
            <h3>
                View latest Grants by Sectors - complete
                list
            </h3>
            <p>
                bidsinfoglobal has the most comprehensive
                database of Grants from 150+ Sectors and
                industries Globally. Find Sector-wise bids,
                eprocurement notices, egrants and more. Get
                Grants by local and international
